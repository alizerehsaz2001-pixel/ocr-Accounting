                        ...
                        <div className="flex flex-col gap-3 border-t pt-4 dark:border-slate-800/60 border-slate-200">
                          ...
                          <div className={`p-3 rounded-2xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 transition-all ${
                            ...
                            <div className="flex flex-col gap-1">
                              <div className="flex items-center gap-1.5 font-extrabold text-[11.5px]">
                                ...
                                <span>دستور ویژه: تبدیل ۱۰۰٪ کلیه اطلاعات (اعداد و متون) به JSON جهت اکسل مستقیم</span>
                              </div>
                              <p className={`text-[10px] leading-relaxed ${isDarkMode ? "text-amber-300/80" : "text-amber-800/80"}`}>
                                «دستور اکید و تضمینی ویژه (Gemini 3.6 Flash): تمام اطلاعات مندرج در این سند را بدون استثنا و ۱۰۰٪ کامل استخراج کن. هر آنچه می‌بینی، از ریزترین اعداد، تاریخ‌ها، کدهای اقتصادی، شناسه ملی، مبالغ جزئی، مالیات، عوارض، تا توضیحات متنی طولانی و آدرس‌ها را به فرمت JSON تبدیل کن. خروجی باید مطلقاً و منحصراً یک آرایه JSON ساختاریافته (بدون تگ مارک‌داون) باشد تا مستقیماً وارد فایل اکسل شود...»
                              </p>
                            </div>
                            <button
                              type="button"
                          ...
                          <div className="flex flex-col gap-1.5 mt-1">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              {[
                                { text: "⚡ تبدیل ۱۰۰٪ کلیه اطلاعات به JSON (جهت اکسل)", query: "دستور اکید و تضمینی ویژه (Gemini 3.6 Flash): تمام اطلاعات مندرج در این سند را بدون استثنا و ۱۰۰٪ کامل استخراج کن. هر آنچه می‌بینی، از ریزترین اعداد، تاریخ‌ها، کدهای اقتصادی، شناسه ملی، مبالغ جزئی، مالیات، عوارض، تا توضیحات متنی طولانی و آدرس‌ها را به فرمت JSON تبدیل کن. خروجی باید مطلقاً و منحصراً یک آرایه JSON ساختاریافته (بدون تگ مارک‌داون ```json، بدون هیچ کلمه اضافه یا توضیح) باشد. تک‌تک سطرها و اقلام باید با کلیدهای فارسی کاملاً شفاف و استاندارد تولید شوند تا بدون نیاز به حتی یک ثانیه ویرایش، مستقیماً سطر به سطر وارد جدول اکسل شوند. تضمین ۱۰۰ درصدی دقت ریاضی مبالغ و یکپارچگی داده‌ها الزامی است." },
              ...
              <section className="flex-1 flex flex-col gap-3 overflow-hidden">
                ...
                {activeTab === "unified" ? (
                  ...
                  <div className={`rounded-xl border flex-1 flex flex-col overflow-hidden shadow-sm transition-all duration-300 ${
                      ...
                      {activeFile.status === "success" && transactions.length > 0 && (() => {
                        ...
                        return (
                          ...
                          <div className={`p-4 rounded-xl border transition-all duration-300 ${
                            isDarkMode ? "bg-slate-900/60 shadow-inner border-slate-800" : "bg-slate-50 border-slate-200 shadow-sm"
                          }`}>
                            {/* Tab Headers */}
                    ...
                    {activeFile.status === "success" && transactions.length > 0 && (
                      <div className={`p-3 flex flex-col gap-3 font-sans transition-colors ${
                        isDarkMode ? "bg-slate-900/80 border-slate-800/80 backdrop-blur-md shadow-sm rounded-xl mb-4" : "bg-white/80 border-slate-200 backdrop-blur-md shadow-sm rounded-xl mb-4"
                      }`} dir="rtl">
