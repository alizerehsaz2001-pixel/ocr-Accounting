                  ...
                  <button
                    ...
                    onClick={() => {
                      if (prompt.includes("۱۰۰٪")) {
                        handleSendMessage(`⚡ دستورالعمل استخراج ۱۰۰٪ نسل ۵ آلترا (موتور ارشد اسکن ۷ زون عمیق سند و خروجی صفر-اغماض Full-Excel):
کلیه اطلاعات این سند را بدون استثنا، بریدگی، خلاصه‌سازی، ادغام یا اغماض، ۱۰۰٪ کامل با دقت مطلق استخراج کن. کلیه ارقام را منحصراً به اعداد انگلیسی (0-9) و بدون جداکننده/واحد پول تبدیل کن. خروجی باید منحصراً یک آرایه مسطح JSON با ۳۵ کلید استاندارد فارسی زیر باشد:
۱) هدر و هویت: نوع_سند، شماره_فاکتور، شماره_سریال_چاپی، شناسه_یکتای_مالیاتی، شماره_پیگیری، شماره_سفارش_خرید_PO، تاریخ_شمسی، تاریخ_میلادی، زمان_ثبت، روش_تسویه.
۲) صادرکننده و خریدار: نام_فروشنده، شناسه_ملی_فروشنده، کد_اقتصادی_فروشنده، شماره_ثبت_فروشنده، استان_شهر_فروشنده، کدپستی_فروشنده، تلفن_فروشنده، آدرس_فروشنده، نام_خریدار، شناسه_ملی_خریدار، کد_اقتصادی_خریدار، شماره_ثبت_خریدار، تلفن_خریدار، آدرس_خریدار.
...
۴) جمع‌ها و بانک: جمع_کل_قبل_تخفیف، جمع_تخفیفات، مبلغ_مشمول_مالیات، جمع_مالیات_و_عوارض، سایر_اضافات، سایر_کسورات، مبلغ_قابل_پرداخت، مبلغ_قابل_پرداخت_حروفی، نام_بانک، شماره_حساب، شماره_کارت، شماره_شبا، صاحب_حساب.
۵) حواشی و ممیزی: توضیحات_سند، وضعیت_مهر_امضا، سایر_اطلاعات_و_حواشی_سند، مغایرت_محاسباتی.`);
                      } else {
