                  ...
                  <button
                    ...
                    onClick={() => {
                      if (prompt.includes("۱۰۰٪")) {
                        handleSendMessage(`⚡ دستورالعمل استخراج ۱۰۰٪ نسل ۷ آلترا ممیزی (موتور Audit-Grade OCR Engine با قانون عدم-حدس Strict Null):
کلیه اطلاعات این سند را با استاندارد حسابرسی رسمی بدون خلاصه‌سازی یا حدس استخراج کن. هر داده مبهم را null بگذار. خروجی باید یک آرایه مسطح JSON با ۴۵ کلید استاندارد فارسی شامل:
۱) کیفیت و هدر: سطح_اطمینان_استخراج، نوع_سند، شماره_فاکتور، شماره_سریال_چاپی، شناسه_یکتای_مالیاتی، شماره_پیگیری، شماره_سفارش_خرید_PO، تاریخ_شمسی، تاریخ_میلادی، تاریخ_میلادی_محاسبه_شده، زمان_ثبت، روش_تسویه.
۲) صادرکننده و خریدار: نام_فروشنده، شناسه_ملی_فروشنده، کد_اقتصادی_فروشنده، شماره_ثبت_فروشنده، استان_شهر_فروشنده، کدپستی_فروشنده، تلفن_فروشنده، آدرس_فروشنده، ایمیل_وبسایت_فروشنده، نام_خریدار، شناسه_ملی_خریدار، کد_اقتصادی_خریدار، شماره_ثبت_خریدار، کدپستی_خریدار، تلفن_خریدار، آدرس_خریدار.
۳) اقلام (هر سطر ۱ آبجکت در آرایه): ردیف، کد_کالا، شرح_کالا، تعداد، واحد_سنجش، قیمت_واحد، مبلغ_کل_ردیف، تخفیف_ردیف، درصد_تخفیف_ردیف، نرخ_مالیات_بر_ارزش_افزوده_ردیف، مالیات_ارزش_افزوده_ردیف، مبلغ_نهایی_ردیف.
۴) مبالغ، واحد ارزی و بانک: واحد_ارزی، جمع_کل_قبل_تخفیف، جمع_تخفیفات، مبلغ_مشمول_مالیات، جمع_مالیات_و_عوارض، سایر_اضافات، سایر_کسورات، مبلغ_قابل_پرداخت، مبلغ_قابل_پرداخت_خام، مبلغ_قابل_پرداخت_حروفی، نام_بانک، شماره_حساب، شماره_کارت، شماره_شبا، صاحب_حساب.
۵) ممیزی و حسابرسی: توضیحات_سند، وضعیت_مهر_امضا، داده_نامطمئن_یا_غیرقابل_خواندن، سایر_اطلاعات_و_حواشی_سند، مغایرت_محاسباتی.`);
                      } else {
