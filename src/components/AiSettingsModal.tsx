            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <div className="flex flex-wrap gap-1.5 mt-1">
                  {[
                    { label: "🚀 ارتقای آلترا (پردازش عمیق ممیزی)", text: "⚡ دستورالعمل ارتقای آلترا پردازش (Ultra Processing Upgrade): پردازش کامل و استخراج ۱۰۰٪ تمام ارقام و متون سند با موازنه دوطرفه ریاضی (تعداد × فی = مبلغ کل)، اعتبارسنجی شناسه ملی و شبا، و رفع خودکار مغایرت‌ها با استاندارد حسابرسی رسمی." },
                    { label: "🛡️ فول‌اکسل (نسل ۷ آلترا ممیزی)", text: "⚡ دستور ویژه فول‌اکسل (نسل ۷ آلترا ممیزی Audit-Grade): استخراج کامل اسناد با استراتژی عدم-حدس (Strict Null)، تفکیک واحد ارزی و متن خام، شاخص اطمینان OCR، اسکن ۸ زون با ۴۵ کلید مسطح JSON و ۵ کنترل متقابل و حسابرسی ریاضی." },
