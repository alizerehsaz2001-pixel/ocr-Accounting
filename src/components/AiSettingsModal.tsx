            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <div className="flex flex-wrap gap-1.5 mt-1">
                  {[
                    { label: "🚀 فول‌اکسل ۱۰۰٪ (نسل ۵ آلترا)", text: "⚡ دستور ویژه فول‌اکسل (نسل ۵ آلترا - صفر-اغماض): استخراج ۱۰۰٪ داده‌ها در اسکن ۷ زون عمیق به آرایه مسطح JSON با اعداد خالص انگلیسی (0-9)، شامل ۳۵ کلید استاندارد فارسی برای هدر، صادرکننده، خریدار، تک‌تک اقلام، مالیات، عوارض، اطلاعات بانکی/شبا، حواشی و موازنه ریاضی خودکار." },
