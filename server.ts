...
۶. قوانین تکمیلی و اصول پیشرفته حسابداری (Advanced Accounting Principles):
...
۷. تکنیک‌های تخصصی استخراج دست‌نویس‌های مخدوش و ناخوانای فارسی (Advanced Persian Handwriting OCR):
